...
const AboutUs = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center pt-[8rem] relative md:pt-[13rem] mx-4 md:mx-16 lg:mx-20 xl:mx-[13.375rem]">
            <div className="text-center w-[100%]">
                ...
                <div className=" w-[100%] relative h-[50rem]">
                    <img src="/organization-bg.svg" alt="organization-background " className="absolute top-[11rem] left-[-12rem] sm:left-[-21rem] md:left-[-25rem] lg:left-[-32rem] xl:left-[-43rem]" />
                    <div className="w-[100%] h-[60rem] relative">
                        <img
                            src="/business-org.svg"
                            alt="business-text"
                            className="absolute w-[14rem] top-[10rem] left-[3rem] sm:w-[18rem] md:w-[21rem] lg:w-[24rem] hover:grayscale-0 hover:md:w-[25rem] duration-200 "
                            onClick={organizationTab[1].onElement}
                        />
                        <img
                            src="/devkor-org.svg"
                            alt="devkor-text"
                            className="absolute w-[14rem] top-[19rem] right-0 sm:w-[18rem] md:w-[21rem] md:top-[23rem] lg:w-[24rem]"
                            onClick={organizationTab[0].onElement}
                        />
                        <img
                            src="/designer-org.svg"
                            alt="designer-text"
                            className="absolute w-[16rem] top-[26rem] left-[3rem] sm:w-[20rem] md:w-[25rem] md:top-[35rem] lg:w-[29rem] "
                ...
                <img
                    ...
                    className="w-[28rem] absolute top-[15rem] left-[-11rem] md:w-[50rem] md:top-[60rem] md:left-[-30rem] xl:w-[55rem] xl:left-[-45rem]"
                />
                <div className="mx-auto h-[50rem] md:my-[25rem] relative">
                    <img
                        src="/business-org.svg"
                        alt="business-text"
                        className="w-[12rem] md:w-[22rem] absolute top-[4rem] left-[-1rem] md:top-[3rem] md:left-[15rem] grayscale-[95%] hover:grayscale-0 hover:md:w-[25rem] duration-200"
                        onClick={organizationTab[1].onElement}
                    />
                    <img
                        src="/devkor-org.svg"
                        alt="devkor-text"
                        className="w-[12rem] md:w-[22rem] absolute top-[14rem] left-[5rem] md:top-[15rem] md:left-[40rem] grayscale hover:grayscale-0 hover:md:w-[25rem] duration-200"
                        onClick={organizationTab[0].onElement}
                    />
                    <img
                        src="/designer-org.svg"
                        alt="designer-text"
                        className="w-[13rem] ml-auto mr-0 md:w-[26rem] absolute top-[22rem] left-[-1rem] md:top-[30rem] md:left-[25rem] grayscale hover:grayscale-0 hover:md:w-[30rem] duration-200"
                        onClick={organizationTab[2].onElement}
                    />
                </div> */}
            </div>
            <div className="m-0 p-0">
                <div className="text-center w-[100%] mt-[30rem] bg-[#1D1D1D] opacity-85">
            ...
            {/* <div className="bg-[#1D1D1D] opacity-85 w-[100%]">
                <div>
                    <div className="text-center p-1">
                        <h2 className="font-impact text-ourWhite text-2xl mt-[10rem] md:text-3xl ">Who We Are?</h2>
                        <h4 className="mt-3 text-ourWhite md:text-lg">2022 KU SUMMER HACKATHON 운영진 소개</h4>
