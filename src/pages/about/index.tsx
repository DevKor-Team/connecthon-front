    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center pt-[8rem] relative ">
                        ...
                        <div className="relative mt-[5rem]">
                            <div className="w-[100%] h-[60rem] relative">
                                ...
                                <img
                                    src="/devkor-org.svg"
                                    alt="devkor-text"
                                    className="absolute w-[14rem] top-[18.5rem] right-[-3rem] sm:w-[18rem] sm:top-[20rem] sm:right-[-7rem] md:w-[21rem] md:right-0 md:top-[23rem] lg:w-[24rem] lg:right-[-5rem] md:grayscale md:hover:grayscale-0 hover:md:w-[27rem] duration-200"
                ...
                <div className="bg-[#1D1D1D] opacity-85 mt-[10rem] w-full">
                    <div className="w-[100%] mt-[8rem] md:pt-[13rem] px-4 md:px-16 lg:px-20 xl:px-[13.375rem]">
                        ...
                        <div className="mt-[20rem]">
                            <div ref={organizationTab[1].element} className="mt-[2rem] pt-[15rem] md:mt-[9rem] md:pt-[12rem]">
                                <BusinessSchool />
                            </div>
                            <div ref={organizationTab[0].element} className="mt-[28rem] pt-[15rem] md:mt-[20rem] md:pt-[10rem]">
                                <DevKor />
                            </div>
                            <div ref={organizationTab[2].element} className="mt-[28rem] pt-[15rem] md:mt-[20rem] md:pt-[12rem]">
                                <Dijo />
                            </div>
                        </div>
                        <div className="w-full mx-auto sm:w-[25rem] mt-[37rem] md:w-[70%]">
