...
const BusinessSchool = () => {
    ...
    return (
        <div className="ml-2 mb-[8rem] w-[90%] md:ml-[2rem] text-left justify-end relative">
            <div className="absolute left-[-5rem] w-[15rem] md:left-[-5rem] md:w-[16rem]">
            ...
            <div className="w-[100%]">
                ...
                <p className="text-[0.625rem] text-white mt-1 leading-[1rem] md:text-[1.1rem] md:leading-[1.75rem] md:w-[70%]">
            ...
            {members ? (
                <div className="flex mt-3">
                    <div className="flex flex-col w-[12%] mr-2 md:my-5 md:mr-5">
                        <div>
                    ...
                    <div className="flex flex-col w-[12%] mr-2 md:my-5">
                        <div>
