...
const Dijo = () => {
    ...
    return (
        <div className="ml-2 w-[80%] md:ml-[3rem] text-left justify-end relative">
            <div className="absolute left-0 w-[10rem] md:w-[14rem] md:left-[-6rem] md:top-[-2rem]">
            ...
            {members ? (
                <div className="flex mt-3">
                    <div className="flex flex-col items-center w-[15%] mr-1 md:my-5 md:mr-3">
                        <div>
                            <img src="/designers/hyuna.jpeg" alt="hyuna" className="md:w-[6rem]" />
                        </div>
                        <p className="text-center text-ourWhite my-3 tracking-wide">김현아</p>
                    </div>
                    <div className="flex flex-col items-center  w-[15%] mx-1  md:my-5 md:mr-3">
                        <div>
